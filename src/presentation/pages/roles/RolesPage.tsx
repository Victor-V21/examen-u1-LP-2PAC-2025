        ...
        <table className="w-full">
          <thead className="bg-blue-500 text-white">
            <tr>
              ...
              <th className="p-2 text-left">Nombre del Rol</th>
                ...
                <tr key={role.id} className="hover:bg-gray-200">
                  ...
                  <td className="p-2">
                    <div className="flex flex-row items-center gap-2">
                      <Link to={`${role.id}/edit`} className="flex flex-row items-center justify-center gap-2 bg-blue-500 text-white hover:bg-blue-600 p-2 rounded-md cursor-pointer" >
                        <Edit size={18} />
                      </Link>
                      <Link to={`${role.id}/delete`} className="flex flex-row items-center justify-center gap-2 bg-blue-500 text-white hover:bg-blue-600 p-2 rounded-md cursor-pointer" >
                        <Trash size={18} />
                      </Link>
                    </div>
                  </td>
